	...
	static void set1(int i) {
		while(true) {
			for(sw[i] = (bwfw==0)?0:sw[i];sw[i]<8;sw[i]++) {
				/*
				if(pos[0]==1 && pos[1]==3 && i==3) {
					System.out.println("섹스");
					System.out.println(sw[i]);
					System.out.println(flag_a[sw[i]]);
				}*/
			...
			if(i==0) {
				...
				System.out.println(Arrays.toString(flag_a));
				System.out.println(Arrays.toString(flag_b));
				System.out.println(Arrays.toString(flag_c));
